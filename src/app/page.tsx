...
export default function HomePage() {
  return (
    ...
    <Box>
      <Typography variant="h4" sx={{ fontWeight: 'bold', mb: 2, mt: 14, textShadow: '2px 2px 2px rgba(0, 0, 0, 0.2)' }}>
        Featured
      </Typography>
      <Divider sx={{ marginY: 2, backgroundColor: '#A7D397', height: 2, boxShadow: '0px 3px 5px 2px rgba(0, 0, 0, 0.2)', }}/>
      <div>
